...
const article2 = () => {
  return (
    <div className='py-10 care-img h-full bg-cover bg-center'>
      <Header/>
    <div className='p-10 backdrop-blur'>
      ...
      <h2 className='text-white font-bold text-2xl mb-2'>What Is Low Impact Exercise?</h2>
      ...
      <h2 className='font-bold text-xl text-white mb-2'>Low-Impact Strength Training Exercises</h2>
